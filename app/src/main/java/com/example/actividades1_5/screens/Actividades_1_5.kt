    ...
    Box(Modifier.fillMaxSize(),
        ...
        TextField(
            ...
            onValueChange = { input ->
                ...
                if (replaced.count { it == '.' } <= 1){
                    if (replaced.substringBefore(".").isDigitsOnly() && replaced.substringAfter(".").isDigitsOnly()){
                        myVal = replaced
                    }
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun Actividad5(myVal: String, onValueChage: (String) -> Unit) {
